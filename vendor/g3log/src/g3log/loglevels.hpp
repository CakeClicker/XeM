...
namespace g3 {
   ...
   static const int kHookingValue = 400;
   static const int kScriptValue = 450;
   static const int kSessionValue = 490;
   static const int kProtectionValue = 550;
} // g3
...
HOOKING{ g3::kHookingValue, {"HOOKING"} },
SCRIPTS{ g3::kScriptValue, {"SCRIPT"} },
SESSION{ g3::kSessionValue, {"SESSION"} },
PROTECTION{ g3::kProtectionValue, {"PROTECTION"} };
